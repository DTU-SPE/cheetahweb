...
public class MeanRelativeDividedTrialAnalyzer extends AbstractPupilTrialAnalyzer {

	public MeanRelativeDividedTrialAnalyzer(AnalyzeConfiguration config, DataProcessing processing) {
		super(config, processing, AnalyzeStepType.MEAN_RELATIVE_DIVIDED);
	}
